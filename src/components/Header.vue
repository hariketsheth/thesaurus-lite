...
<template>
  <div v-if="infoOpen" class="info">
    <div>
      ...
      <p>
        <strong>Thesaurus Lite</strong> was built by <a class="link" href="https://twitter.com/Hariketsheth">@HariketSheth</a>.
        It's open-source and available on <a class="link" href="https://github.com/hariketsheth/thesaurus-lite">GitHub</a>, be creative!
      </p>
      <p>
        Thesaurus Lite uses <a class="link" href="https://liveblocks.io/">Liveblocks</a> to add multiplayer, which I wholeheartedly recommend trying.
        Give me a tag if you build anything fun.
      </p>
      <p>
        I also write interactive web dev articles on my website: <a class="link" href="https://hariketsheth.github.io">hariketsheth.github.io</a>
      </p>
      <div class="divider" />
      <h2 class="mt-6">How to play</h2>
      <p>
        Guess the <strong>THESAURUS</strong> in six tries.
      </p>
      <p>
      ...
      <p>
        The player with the lowest amount of guesses wins <strong>Thesaurus Lite</strong>.
      </p>
      <div class="divider" />
      <p>
      ...
      <div class="divider" />
      <p>
        <strong>A new THESAURUS will be available each day!</strong>
      </p>
  ...
  <header>
    <div>
      ...
      <a class="button" href="https://github.com/hariketsheth/thesaurus-lite" target="_blank">
