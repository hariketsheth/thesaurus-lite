...
/**
 * Thesaurus Lite is a game that allows for multiplayer gameplay. It works
...
/**
 * Thesaurus Lite has a number of different game states, such as CONNECTING, READY,
...
function createEmojiScore (successGrid: string) {
  let resultString = `#ThesaurusLite #${answerDay}\n\n`
  sortedUsers.forEach((user, index) => {
    resultString += `${index + 1}. ${user.name}\n`
  })
  resultString += '\n' + successGrid
  return resultString + '\n\nhttps://thesaurus-lite.vercel.app'
}
</script>
        ...
        <div v-if="gameState === GameState.SCORES" id="scores">
          <div>
            ...
            <div class="text-center mt-2">
              Follow me on <a class="font-semibold text-green-600 dark:text-green-500" href="https://twitter.com/HariketSheth">Twitter</a> for more fun experiments.
            </div>
